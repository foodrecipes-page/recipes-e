...
Recipe cache shard for **[foodrecipes.page](https://foodrecipes.page)** — AI-generated recipes whose slug starts with **the letter 'e'**.
...
```
https://cdn.jsdelivr.net/gh/foodrecipes-page/recipes-e@main/recipes/<cuisine>/<diet>/<slug>.json
```
